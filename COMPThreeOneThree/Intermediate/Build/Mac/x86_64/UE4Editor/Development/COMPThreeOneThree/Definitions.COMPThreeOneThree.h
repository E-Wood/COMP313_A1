...
#define UE_PROJECT_NAME COMPThreeOneThree
#define UE_TARGET_NAME COMPThreeOneThreeEditor
#define UE_MODULE_NAME "COMPThreeOneThree"
...
#define COMPTHREEONETHREE_API DLLEXPORT
